...
par(mar=c(4,4,2,2))
	...
	##Plot A
	plot(alldata$DateTimeCombo,alldata$Global_active_power,
	type="l",
	...
	##Plot C
	plot(alldata$DateTimeCombo,alldata$Voltage,
	type="l",
	xlab="datetime",ylab="Voltage")

	##Plot D
	plot(alldata$DateTimeCombo,alldata$Global_reactive_power,
	type="l",
